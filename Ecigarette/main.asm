...
.equ buttonCutoff = 0x5B		//0x07 = 100 ms on 8 MHz, prescaler=64, system divider=8
...
ANDI R16, (1 << 3 | 1 << 4)		//If no buttons is pressed, the int is generated on button release
...
;	LDI R16, 0x13
	...
	//debug
	MOV R16, R14				//Load the ordinal number of the cell, that displayed now (supra)
	///debug
